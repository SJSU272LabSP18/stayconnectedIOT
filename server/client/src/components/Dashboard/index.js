                    ...
                    <div>
                        <div className="wrapper">
                            <div className="main-panel">
                                ...
                                <Route exact path="/dashboard/locations/:locationId/zones" component={Zones}/>
                                <Route exact path="/dashboard/:siteId/locations" component={Locations}/>
                                <Route exact path="/dashboard/locations" component={Locations}/>
                                <Route exact path="/dashboard/zones/:zoneId/nodes" component={Nodes}/>
